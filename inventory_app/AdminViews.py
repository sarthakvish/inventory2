...
def admin_home(request):
    ...
    total_issue_quantity = StockHistory.objects.filter(auth_user_id=auth_user_id).aggregate(Sum('issue_quantity'))[
        'issue_quantity__sum']
    total_receive_quantity = StockHistory.objects.filter(auth_user_id=auth_user_id).aggregate(Sum('receive_quantity'))[
        'receive_quantity__sum']
